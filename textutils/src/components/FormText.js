    ...
    return (
        <>
            <div className='container my-4'>
                ...
                <button disabled={text.length===0} className="btn btn-primary my-2 mx-1" onClick={handleclick} >Convert to Uppercase</button>
                <button disabled={text.length===0} className="btn btn-primary my-1 mx-1" onClick={handleclick2} >Convert to Lowercase</button>
